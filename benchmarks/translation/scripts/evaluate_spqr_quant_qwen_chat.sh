...
nohup python -u ../evaluate_spqr_quant_qwen_chat.py \
    ...
    --eval_data_path ${work_dir}/datasets/flores200_dataset/devtest/eng_Latn.devtest \
    --save_result_path ${work_dir}/quant_eval_results/flores200_dataset/zho_Hans.spqr_${num_bits}g16_Qwen-${model_size}-Chat.devtest \
    --source_lang English \
    --target_lang Chinese \
    --pid ${pid} > evaluate_spqr_quant_qwen_chat.spqr_${num_bits}g16_Qwen-${model_size}-Chat.logs 2>&1 &
