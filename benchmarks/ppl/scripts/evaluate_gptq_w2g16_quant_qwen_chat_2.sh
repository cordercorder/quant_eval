...
quant_checkpoint_path=${work_dir}/pretrained_models.quant/gptq_w2g16_01_Qwen-${model_size}-Chat
save_result_path=${work_dir}/quant_eval_results/ppl/gptq_w2g16_01_Qwen-${model_size}-Chat.json

# quant_checkpoint_path=${work_dir}/pretrained_models.quant/gptq_w2g16_Qwen-${model_size}-Chat
# save_result_path=${work_dir}/quant_eval_results/ppl/gptq_w2g16_Qwen-${model_size}-Chat.json
...
nohup python ../evaluate_gptq_quant_qwen_chat_2.py \
    ...
    --pid ${wait_pid} > logs/evaluate_gptq_quant_qwen_chat_2.gptq_w2g16_01_Qwen-${model_size}-Chat.logs 2>&1 &
echo $!
