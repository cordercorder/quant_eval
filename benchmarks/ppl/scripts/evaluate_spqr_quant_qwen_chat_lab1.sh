...
quant_model_name=spqr_${num_bits}g16_without_outlier_2quant_Qwen-${model_size}-Chat
quant_checkpoint_path=${work_dir}/pretrained_models.quant/${quant_model_name}
save_result_path=${work_dir}/quant_eval_results/ppl/${quant_model_name}.json
...
python ../evaluate_spqr_quant_qwen_chat_2.py \
    ...
    --pid ${wait_pid} > logs/evaluate_spqr_quant_qwen_chat_2.${quant_model_name}.logs 2>&1
echo $!
